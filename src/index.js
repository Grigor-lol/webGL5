...
tex2Mat = registerTexture("src//img//tree.jpg")
tex3 = registerTexture("src//img//3.png")
tex3Mat = registerTexture("src//img//mramor.jpg")
...
coefElement.addEventListener("input", () => {
    ...
    gl.uniform3fv(vecColors, [0, 0.84, 0.5])
    ...
    gl.uniform3fv(vecColors, [0.9, 0.3, 0.3])
